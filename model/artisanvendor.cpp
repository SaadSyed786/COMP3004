...
ArtisanVendor::ArtisanVendor(QString uname, QString ownerName, QString businessName,
                              QString email, QString phone, QString mailingAddress)
    : Vendor(uname, ownerName, businessName, Vendor::Artisan, email, phone, mailingAddress) {}

ArtisanVendor::~ArtisanVendor() {}

bool ArtisanVendor::hasRequiredDocs()
{
    // artisan vendors only need 2 docs: business licence + liability insurance
